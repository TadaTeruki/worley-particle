...
impl<'a> FbsParticleParameters<'a> {
  ...
  pub fn seed(&self) -> u64 {
    ...
    unsafe { self._tab.get::<u64>(FbsParticleParameters::VT_SEED, Some(0)).unwrap()}
  }
  #[inline]
  pub fn min_randomness(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FbsParticleParameters::VT_MIN_RANDOMNESS, Some(0.0)).unwrap()}
  }
  #[inline]
  pub fn max_randomness(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FbsParticleParameters::VT_MAX_RANDOMNESS, Some(0.0)).unwrap()}
  }
  #[inline]
  pub fn scale(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FbsParticleParameters::VT_SCALE, Some(0.0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> FbsParticleParametersBuilder<'a, 'b, A> {
  ...
  pub fn add_seed(&mut self, seed: u64) {
    self.fbb_.push_slot::<u64>(FbsParticleParameters::VT_SEED, seed, 0);
  }
  #[inline]
  pub fn add_min_randomness(&mut self, min_randomness: f64) {
    self.fbb_.push_slot::<f64>(FbsParticleParameters::VT_MIN_RANDOMNESS, min_randomness, 0.0);
  }
  #[inline]
  pub fn add_max_randomness(&mut self, max_randomness: f64) {
    self.fbb_.push_slot::<f64>(FbsParticleParameters::VT_MAX_RANDOMNESS, max_randomness, 0.0);
  }
  #[inline]
  pub fn add_scale(&mut self, scale: f64) {
    self.fbb_.push_slot::<f64>(FbsParticleParameters::VT_SCALE, scale, 0.0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> FbsParticleParametersBuilder<'a, 'b, A> {
...
impl<'a> FbsParticle<'a> {
  ...
  pub fn value(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FbsParticle::VT_VALUE, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> FbsParticleBuilder<'a, 'b, A> {
  ...
  pub fn add_value(&mut self, value: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FbsParticle::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> FbsParticleBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    FbsParticleBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> FbsParticleMap<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.particles { builder.add_particles(x); }
  ...
  pub fn params(&self) -> Option<FbsParticleParameters<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<FbsParticleParameters>>(FbsParticleMap::VT_PARAMS, None)}
  }
  #[inline]
  pub fn particles(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<FbsParticle<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<FbsParticle>>>>(FbsParticleMap::VT_PARTICLES, None)}
  }
}
...
impl flatbuffers::Verifiable for FbsParticleMap<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<FbsParticleParameters>>("params", Self::VT_PARAMS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<FbsParticle>>>>("particles", Self::VT_PARTICLES, false)?
     .finish();
    Ok(())
  }
}
pub struct FbsParticleMapArgs<'a> {
    ...
    pub particles: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<FbsParticle<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> FbsParticleMapBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_params(&mut self, params: flatbuffers::WIPOffset<FbsParticleParameters<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<FbsParticleParameters>>(FbsParticleMap::VT_PARAMS, params);
  }
  #[inline]
  pub fn add_particles(&mut self, particles: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<FbsParticle<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FbsParticleMap::VT_PARTICLES, particles);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> FbsParticleMapBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub fn root_as_fbs_particle_map(buf: &[u8]) -> Result<FbsParticleMap, flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_fbs_particle_map(buf: &[u8]) -> Result<FbsParticleMap, flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn size_prefixed_root_as_fbs_particle_map_unchecked(buf: &[u8]) -> FbsParticleMap {
...
#[inline]
pub fn finish_size_prefixed_fbs_particle_map_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>, root: flatbuffers::WIPOffset<FbsParticleMap<'a>>) {
